<template>
    <DashboardLayout>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white p-7 rounded-3xl shadow-md shadow-slate-black-200">
        ...
        <div class="mt-8 bg-white p-7 rounded-3xl shadow-md shadow-slate-black-200">
